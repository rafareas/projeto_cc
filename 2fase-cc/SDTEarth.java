...
public class SDTEarth {
    public static void main(String[] args) throws IOException {
        byte[] buf = new byte[256];

        //armazenamento das base de dados
        ReadDataBase readEarth = new ReadDataBase();
        ArrayList<DBelement> dataBaseEarth = new ArrayList<>(readEarth.ReadDataBase("C:/Users/rafael/Documents/UNIVERSIDADE/Comunicacao_de_Computadores/2fase-cc/baseDeDados/earthDB.txt"));

        //recebe a query do servidor de resolucao
        DatagramPacket DpReceive = new DatagramPacket(buf, buf.length);
        DatagramSocket DsReceive = new DatagramSocket(6666, InetAddress.getByName("127.0.0.15"));
        ...
        //nao achou
        int procuraMoon = readEarth.searchDataBase(dataBaseEarth, domain, type);
        if (procuraMoon == 0) {
