...
public class SDTmoon {
    public static void main(String[] args) throws IOException {
        byte[] buf = new byte[256];

        //armazenamento das base de dados
        ReadDataBase readMoon = new ReadDataBase();
        ArrayList<DBelement> dataBaseMoon = new ArrayList<>(readMoon.ReadDataBase("C:/Users/rafael/Documents/UNIVERSIDADE/Comunicacao_de_Computadores/2fase-cc/baseDeDados/moonDB.txt"));

        //recebe a query do servidor de resolucao
        DatagramPacket DpReceive = new DatagramPacket(buf, buf.length);
        DatagramSocket DsReceive = new DatagramSocket(6666, InetAddress.getByName("127.0.0.10"));
        ...
        if (procuraMoon == 0) {
            ...
            if (find == 1) {
                ...
                while (count > 0) {
                    ...
                    procuraD = readMoon.searchNSDataBase(dataBaseMoon, domainN);
                    if (procuraD == 1) {
                        dom = domainN;
                ...
                authoritiesValues = readMoon.getAuthoritiesValues(dataBaseMoon, authoritiesValues, dom);
